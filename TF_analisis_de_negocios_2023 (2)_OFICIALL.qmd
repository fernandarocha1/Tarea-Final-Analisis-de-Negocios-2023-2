...
```{r}
train <- read.csv("C:/Users/GOMUG/OneDrive/Desktop/Semestre 2023-1/Analisis de Negocios/Trabajo Final/Train.csv")
```

```{r}
test <- read.csv("C:/Users/GOMUG/OneDrive/Desktop/Semestre 2023-1/Analisis de Negocios/Trabajo Final/Test.csv")
```
